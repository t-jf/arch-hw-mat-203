...
\begin{enumerate}[a.]
	\item Cylindrically -- cylindrical "shells" to form sphere
        ...
        $2\int_{r = 0}^{r = 1} \int_{\theta = 0}^{\theta = 2\pi} \int_{z = 0}^{z = \sqrt{1-r^2}} dz d\theta dr$

        $2\int_{r = 0}^{r = 1} \int_{\theta = 0}^{\theta = 2\pi} \sqrt{1-r^2} d\theta dr$

        $2\int_{r = 0}^{r = 1} \sqrt{1-r^2} d\theta dr$
